...
public class SwaggerConfig {
    ...
    private static final String SWAGGER_PROPERTY_HOST = "app.swagger.host";
    ...
    public Docket customImplementation(){
        String name = this.environment.getProperty(REQUEST_PROPERTY_TOKEN_NAME, "Auth-Token");
        String description = this.environment.getProperty(REQUEST_PROPERTY_TOKEN_DESCRIPTION, "令牌值");
        String type = this.environment.getProperty(REQUEST_PROPERTY_TOKEN_TYPE, "header");
        Boolean enable = this.environment.getProperty(SWAGGER_PROPERTY_ENABLE, Boolean.class, true);
        String host = this.environment.getProperty(SWAGGER_PROPERTY_HOST, String.class);
