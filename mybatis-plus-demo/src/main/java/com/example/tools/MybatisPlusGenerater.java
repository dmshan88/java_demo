...
public class MybatisPlusGenerater {
    ...
    // 数据源配置
    private final static String DATABASE_URL = "jdbc:mysql://localhost:3306/demo?useUnicode=true&useSSL=false&characterEncoding=utf8&nullCatalogMeansCurrent=true";// 数据库id
    private final static String DATABASE_DRIVER = "com.mysql.jdbc.Driver";// 数据库名称
    private final static String DATABASE_USER = "root";
    private final static String DATABASE_PASSWORD = "root";
    // 包配置
    private final static String PACKAGE_NAME = "com.example.mybatis";// 父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
